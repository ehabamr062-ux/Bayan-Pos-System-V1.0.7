...
(function () {
    ...
    function getActiveIdx() {
        return parseInt(getStore(ACTIVE_IDX_KEY) || '0', 10);
    }

    function setActiveIdx(idx) {
        setStore(ACTIVE_IDX_KEY, String(idx));
        setStore(STORAGE_KEY, GEMINI_KEYS[idx]);
    ...
    function initKeys() {
        ...
        setStore(STORAGE_KEY, allKeys);
        setStore(ACTIVE_IDX_KEY, '0');
