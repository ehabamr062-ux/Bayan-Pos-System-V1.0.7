...
async function initAppStore() {
    ...
    if (typeof Dexie !== 'undefined') {
        ...
        window.bayanDB.version(4).stores({
        ...
        try {
            ...
            console.warn("⚠️ Database open failed, self-healing by deleting and recreating database...", openError);
            try {
                await Dexie.delete("BayanDatabase");
            } catch(e) {}
            location.reload();
            return;
        }
