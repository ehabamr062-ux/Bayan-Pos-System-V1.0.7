...
data.forEach(store => {
        ...
        function switchSection(sectionType, fromTab = false, tabId = null) {
            ...
            if (!fromTab && !tabId) {
                ...
                const multiInstanceSections = [
                    ...
                    'analysis', 'item-history', 'adjustment', 'reports-hub', 'warehouse-report', 'price-tracking', 'product-inquiry', 'ai-assistant', 'statement'
                ];
            ...
            if (targetTab.type === 'statement') {
                ...
                // Removed generateAccountStatement() here to avoid infinite loop
            }
    ...
    let calcExpression = "";
    let calcHistory = JSON.parse(getStore('bayan_calc_history') || '[]');
